...
<template>
  <div
    class="
      ...
      items-center max-w-full px-3.8
      3xl:px-37
    "
  >
    <a class="inline-block max-w-[120px] sm:max-w-[158px]" href="/"
      ><img src="/images/logo/dark-logo.png" alt="Logo" width="158" height="26"
    /></a>
    <nav
      aria-label="Main Menu"
      class="relative mx-auto hidden xl:block"
    >
      <ul aria-label="Main Menu" role="menubar">
        ...
        >
          <a
            ...
            aria-haspopup="true"
            aria-expanded="false"
            >Home<i class="fa fa-chevron-down ml-2 text-xs"></i
          ></a>
          <div
            class="
              w-[1170px]
          ...
          >
            ...
            <div class="px-3.8 shrink-0 grow-0 w-1/2 basis-1/2">
              ...
              <a href="/"
                ><img src="/images/menu/mega-menu.jpg" alt="Banner"
              /></a>
            </div>
          </div>
        </li>
        ...
        >
          <a
            ...
            aria-haspopup="true"
            aria-expanded="false"
            >Pages<i class="fa fa-chevron-down ml-2 text-xs"></i
          ></a>
          <ul
            class="
              absolute
          ...
          >
            <li role="none" class="relative">
              <a
                class="
                  flex items-center text-secondary px-7.5 py-2
                "
                role="menuitem"
                href="/start-here"
                >Start Here</a
        ...
        >
          <a
            ...
            aria-haspopup="true"
            aria-expanded="false"
            >Courses<i class="fa fa-chevron-down ml-2 text-xs"></i
          ></a>
          <ul
            class="
              absolute
        ...
        >
          <a
            ...
            aria-haspopup="true"
            aria-expanded="false"
            >Event<i class="fa fa-chevron-down ml-2 text-xs"></i
          ></a>
          <ul
            class="
              absolute
        ...
        >
          <a
            ...
            aria-haspopup="true"
            aria-expanded="false"
            >Blog<i class="fa fa-chevron-down ml-2 text-xs"></i
          ></a>
          <ul
            class="
              absolute
    ...
    <div class="flex justify-end items-center">
      ...
      <button
        ...
        type="button"
        class="toggle group pl-5 xl:hidden"
      >
        <i
          class="
            icon-top
        ...
        ><i
          class="
            icon-middle
            mt-1.5 relative block overflow-hidden w-6 h-0.5
            before:absolute
            before:content-['']
            before:top-0
            before:left-0
