                ...
                <div class="col-lg-8 col-12 order-lg-1 max-mb-50">
                    ...
                    <div class="course-details-wrapper">
                        <div class="tab-menu">
                            <ul class="nav">
                                <li class="nav-item">
                                    <a class="nav-link" @click.prevent="setActive('overview')" :class="{ active: isActive('overview') }" href="#overview">
                                        Overview
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" @click.prevent="setActive('instructor')" :class="{ active: isActive('instructor') }" href="#instructor">
                                        Instructor
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" @click.prevent="setActive('reviews')" :class="{ active: isActive('reviews') }" href="#reviews">
                                        Reviews
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" :class="{ 'active show': isActive('overview') }" id="overview">
                            ...
                            <div class="tab-pane fade" :class="{ 'active show': isActive('instructor') }" id="instructor">
                                <CourseInstructor />
                            </div>
                            <div class="tab-pane fade" :class="{ 'active show': isActive('reviews') }" id="reviews">
