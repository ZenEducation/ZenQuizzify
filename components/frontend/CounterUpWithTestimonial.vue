<template>
    <div class="section-padding bg-pattern fix counterup-testimonial" :style="{ 'background-color': '#f5f1ed', backgroundImage: `url('/images/bg/background-pattern-grid-line.png')` }">
        <div class="container">
            <!-- Section Title Start -->
