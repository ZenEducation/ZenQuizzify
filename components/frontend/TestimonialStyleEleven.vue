<template>
    <div class="testimonial-section section-fluid-two section-padding-top">
        <div class="container">
            <!-- Section Title Start -->
            <div class="section-title-four text-center" data-aos="fade-up">
                <span class="sub-title">Testimonials</span>
                <h2 class="title fz-48">Why do people love me?</h2>
            </div>
            <!-- Section Title End -->

            <div class="testimonial-slider-three-item position-relative">
                <swiper
                    :slides-per-view="3"
                    :space-between="30"
                    :speed="1000"
                ...
                >
                    <swiper-slide>
                        <div class="testimonial-two testimonial-three testimonial-kitchen">
                            ...
                            <div class="content">
                                ...
                                <p>I'm CEO of Mina Kitchen Coach, I made my website by MaxCoach and I love that. The support team is helpful & nice.</p>
                            </div>
                            <div class="author-info">
                                <div class="image">
                                    <img src="/images/testimonial/70/testimonial-1.jpg" alt="image">
                                </div>
                                <div class="cite">
                                    <h6 class="name">Mina Hollace</h6>
                    ...
                    <swiper-slide>
                        <div class="testimonial-two testimonial-three testimonial-kitchen">
                            ...
                            <div class="content">
                                ...
                                <p>Thanks for always keeping MaxCoach theme up to date. Your level of support and dedication is second to none.</p>
                            </div>
                            <div class="author-info">
                                <div class="image">
                                    <img src="/images/testimonial/70/testimonial-2.jpg" alt="image">
                                </div>
                                <div class="cite">
                    ...
                    <swiper-slide>
                        <div class="testimonial-two testimonial-three testimonial-kitchen">
                            ...
                            <div class="content">
                                ...
                                <p>Deserves 5 star for theme’s features, design quality, flexibility, customizability and support service!</p>
                            </div>
                            <div class="author-info">
                                <div class="image">
                                    <img src="/images/testimonial/70/testimonial-3.jpg" alt="image">
                                </div>
                                <div class="cite">
                    ...
                    <swiper-slide>
                        <div class="testimonial-two testimonial-three testimonial-kitchen">
                            ...
                            <div class="content">
                                <h4 class="title">Good Design!</h4>
                                <p>I love what they do with their themes. Update & upgrade frequently. Then, I and other customers can earn the best from it.</p>
                            </div>
                            <div class="author-info">
                                <div class="image">
                                    <img src="/images/testimonial/70/testimonial-4.jpg" alt="image">
                                </div>
                                <div class="cite">
                ...
                <div class="circle-slider-prev swiper-button-prev ht-swiper-button-nav">
                    <i class="fal fa-angle-left"></i>
                </div>
                <div class="circle-slider-next swiper-button-next ht-swiper-button-nav">
